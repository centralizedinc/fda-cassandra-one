<template>
  <v-layout row wrap>
    <v-toolbar
      ...
      app
      color="primary"
      style="background-image: url('https://pixinvent.com/materialize-material-design-admin-template/app-assets/images/gallery/breadcrumb-bg.jpg');  background-size: cover"
    >
      <v-layout row wrap>
        <v-flex xs12 mt-4>
      ...
      <v-list>
        ...
        <v-tooltip right>
          <v-list-group prepend-icon="inbox" slot="activator" append-icon="expand_more">
            ...
            <v-list-tile
              class="ma-1"
              @click="goTo('/app/dockets/new')"
              :style="activeRoute(['New Docket'])"
            >
              <v-list-tile-action>
            ...
            <v-list-tile
              class="ma-1"
              @click="goTo('/app/cases/evaluate')"
              :style="activeRoute(['Evaluate Case'])"
            >
              <v-list-tile-action>
            ...
            <v-list-tile
              class="ma-1"
              @click="goTo('/app/cases/review')"
              :style="activeRoute(['Review Case'])"
            >
              <v-list-tile-action>
            ...
            <v-list-tile
              class="ma-1"
              @click="goTo('/app/cases/approve')"
              :style="activeRoute(['Approve Case'])"
            >
              <v-list-tile-action>
            ...
            <v-list-tile
              class="ma-1"
              @click="goTo('/app/cases/finalize')"
              :style="activeRoute(['Finalize Case'])"
            >
              <v-list-tile-action>
            ...
            <v-list-tile
              class="ma-1"
              @click="goTo('/app/cases/execute')"
              :style="activeRoute(['Execute Case'])"
            >
              <v-list-tile-action>
        ...
        <v-tooltip right>
          <v-list-group prepend-icon="move_to_inbox" slot="activator" append-icon="expand_more">
            ...
            <!-- PER  -->
            <v-list-tile
              @click="goTo('/app/cases/per')"
              class="ma-1"
              :style="activeRoute(['Post Execution Report'])"
            >
              <v-list-tile-action>
                <v-icon class="pl-4" small>playlist_add_check</v-icon>
              </v-list-tile-action>
