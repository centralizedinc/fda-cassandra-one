  ...
  data() {
    return {
      ...
      itemsDirectives: ["Service Only", "Padlocking", "Seizure", "Sealing"],
       items: [
        { header: 'Today' },
        { avatar: 'https://cdn.vuetifyjs.com/images/lists/1.jpg', title: 'Joel C. Ubalde, Special Investigator IV', subtitle: "<span class='text--primary'>about 21 hours ago</span> &mdash; Evaluated this case and Submit for Review" },
        { divider: true, inset: true },
        { avatar: 'https://cdn.vuetifyjs.com/images/lists/2.jpg', title: 'Friane Gaitan, Special Investigator II', subtitle: "<span class='text--primary'>about 18 hours ago</span> &mdash; Updated this case and Evaluate Action/Status " },
        { divider: true, inset: true },
         { avatar: 'https://cdn.vuetifyjs.com/images/lists/3.jpg', title: 'Taciana Daisy E. Pascual,  Admin Aide VI, LSSC', subtitle: "<span class='text--primary'>about 15 hours ago</span> &mdash;  Uploaded a new case document " },
        { divider: true, inset: true },
         { avatar: 'https://cdn.vuetifyjs.com/images/lists/1.jpg', title: 'Taciana Daisy E. Pascual,  Admin Aide VI, LSSC', subtitle: "<span class='text--primary'>about 15 hours ago</span> &mdash;  Received and Docketed " },
      ]
    };
  }
};
